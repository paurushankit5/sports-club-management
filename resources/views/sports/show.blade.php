...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="{{ url('/sports') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="sport_name" id="sport_name" class="form-control" value="{{$model['sport_name'] or ''}}" readonly="readonly">
            </div>
        </div>
